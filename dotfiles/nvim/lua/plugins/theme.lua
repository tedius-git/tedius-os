                ...
                sections = {
                    lualine_a = {
                        ...
                        },
                        {
                            ...
                            color = function()
                                local mode_colors = {
                                    n = { bg = catppuccin.surface0, fg = catppuccin.blue },
                                    i = { bg = catppuccin.surface0, fg = catppuccin.green },
                                    v = { bg = catppuccin.surface0, fg = catppuccin.mauve },
                                    r = { bg = catppuccin.surface0, fg = catppuccin.red },
                                }
                                return mode_colors[vim.fn.mode()] or { bg = catppuccin.surface0, fg = catppuccin.text }
                            end,
                        },
                    ...
                    lualine_b = {
                        {
                            ...
                            left_padding = 0,
                            right_padding = 0,
                            color = { bg = "NONE", fg = catppuccin.surface1 },
                        },
                        {
                            function()
                            ...
                            left_padding = 0,
                            right_padding = 0,
                            color = { bg = catppuccin.peach, fg = catppuccin.surface1 },
                        },
                        {
                            "filename",
                            separator = { left = "", right = "" },
                        ...
                        {
                            function()
                                return vim.fn.isdirectory('.git') == 1 and " " or ""
                            end,
                            separator = { left = "", right = "" },
                            left_padding = 0,
                            right_padding = 0,
                    ...
                    lualine_z = {
                        ...
                        },
                        {
                            function()
                                local recording = vim.fn.reg_recording()
                                if recording ~= "" then
                                    return "" .. recording -- Icono y registro
                                end
                                return ""
                            end,
                            cond = function()
